...
#import "StartInterestViewController.h"

@interface StartInterestViewController ()

@end

@implementation StartInterestViewController
...
- (void)viewDidLoad {
    ...
    self.interestCollect.dataSource=self;
    self.interestCollect.delegate=self;
    [self.interestCollect setBackgroundColor:[UIColor clearColor]];
